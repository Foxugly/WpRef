...
export interface TokenCreateRequestParams {
    tokenObtainPairDto: TokenObtainPairDto;
}
...
export class TokenApi extends BaseService {
    ...
    public tokenCreate(requestParameters: TokenCreateRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const tokenObtainPairDto = requestParameters?.tokenObtainPairDto;
        if (tokenObtainPairDto === null || tokenObtainPairDto === undefined) {
            throw new Error('Required parameter tokenObtainPairDto was null or undefined when calling tokenCreate.');
        }
    ...
    public tokenRefreshCreate(requestParameters: TokenRefreshCreateRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const tokenRefreshDto = requestParameters?.tokenRefreshDto;
        if (tokenRefreshDto === null || tokenRefreshDto === undefined) {
            throw new Error('Required parameter tokenRefreshDto was null or undefined when calling tokenRefreshCreate.');
        }
