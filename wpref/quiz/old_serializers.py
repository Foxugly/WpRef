# quiz/api/old_serializers.py
from question.serializers import QuestionSerializer, QuestionLiteSerializer
from rest_framework import serializers
from subject.serializers import SubjectSerializer

from .models import QuizTemplate, Quiz, QuizAttempt, QuizQuestion
...
class QuizSessionSerializer(serializers.ModelSerializer):
    ...
    questions = QuizQuestionSerializer(source="quiz.questions", many=True, read_only=True)
